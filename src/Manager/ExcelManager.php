...
class ExcelManager extends Spreadsheet
{
    ...
    public function defineWorksheet($fileName)
    {
        ...
        $this->getProperties()->setDescription($this->translate('This information is confidential. Generated by Kookaburra (' . GlobalHelper::getParam('absoluteURL') . ')'))
            ->setCompany(ProviderFactory::create(Setting::class)->getSettingByScopeAsString('System', 'organisationName'))
        ;
     ...
     * @return string
     */
    public function translate(string $id, array $params = [], string $domain = 'messages'): string
    {
