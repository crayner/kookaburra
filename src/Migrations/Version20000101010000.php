...
final class Version20000101010000 extends AbstractMigration
{
  ...
  KEY `IDX_D6CA42175A9AE6E` (`gibbonPersonID2`)
        ...
        $this->addSql('CREATE TABLE gibbonFamilyUpdate (gibbonFamilyUpdateID INT(9) UNSIGNED ZEROFILL AUTO_INCREMENT, status VARCHAR(8) DEFAULT \'Pending\' NOT NULL, nameAddress VARCHAR(100) NOT NULL, homeAddress LONGTEXT NOT NULL, homeAddressDistrict VARCHAR(255) NOT NULL, homeAddressCountry VARCHAR(255) NOT NULL, languageHomePrimary VARCHAR(30) NOT NULL, languageHomeSecondary VARCHAR(30) NOT NULL, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, AcademicYearID INT(3) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonFamilyID INT(7) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDUpdater INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_438A3D3B71FA7520 (AcademicYearID), INDEX IDX_438A3D3B51F0BB1F (gibbonFamilyID), INDEX IDX_438A3D3B71106375 (gibbonPersonIDUpdater), INDEX gibbonFamilyIndex (gibbonFamilyID, AcademicYearID), PRIMARY KEY(gibbonFamilyUpdateID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
  ...
  `nameInCharacters` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `gender` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'Unspecified\',
  `username` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `password` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `passwordStrong` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `passwordStrongSalt` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `passwordForceReset` varchar(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'N\' COMMENT \'Force user to reset password on next login.\',
  `status` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'Full\',
  `canLogin` varchar(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'Y\',
  `gibbonRoleIDAll` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT \'(DC2Type:simple_array)\',
  `dob` date DEFAULT NULL,
  `email` varchar(75) COLLATE utf8_unicode_ci DEFAULT NULL,
  `emailAlternate` varchar(75) COLLATE utf8_unicode_ci DEFAULT NULL,
  `image_240` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lastIPAddress` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `lastTimestamp` datetime DEFAULT NULL,
  `lastFailIPAddress` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lastFailTimestamp` datetime DEFAULT NULL,
  `failCount` int(1) DEFAULT NULL,
  `address1` longtext COLLATE utf8_unicode_ci NOT NULL,
  `address1District` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `address1Country` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `address2` longtext COLLATE utf8_unicode_ci NOT NULL,
  `address2District` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `address2Country` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `phone3Type` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `phone3CountryCode` varchar(7) COLLATE utf8_unicode_ci NOT NULL,
  `phone3` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `phone4Type` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `phone4CountryCode` varchar(7) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `birthCertificateScan` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `citizenship1PassportScan` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `citizenship2` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `citizenship2Passport` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `religion` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `nationalIDCardNumber` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `nationalIDCardScan` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `residencyStatus` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `visaExpiryDate` date DEFAULT NULL,
  `profession` varchar(90) COLLATE utf8_unicode_ci NOT NULL,
  `employer` varchar(90) COLLATE utf8_unicode_ci NOT NULL,
  `jobTitle` varchar(90) COLLATE utf8_unicode_ci NOT NULL,
  `emergency1Name` varchar(90) COLLATE utf8_unicode_ci NOT NULL,
  `emergency1Number1` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `emergency1Number2` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `emergency1Relationship` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `emergency2Name` varchar(90) COLLATE utf8_unicode_ci NOT NULL,
  `emergency2Number1` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `emergency2Number2` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `emergency2Relationship` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `studentID` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `dateStart` date DEFAULT NULL,
  `dateEnd` date DEFAULT NULL,
  `lastSchool` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `nextSchool` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `departureReason` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `transport` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `transportNotes` longtext COLLATE utf8_unicode_ci NOT NULL,
  `calendarFeedPersonal` varchar(192) COLLATE utf8_unicode_ci DEFAULT NULL,
  `viewCalendarSchool` varchar(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'Y\',
  `viewCalendarPersonal` varchar(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'Y\',
  `viewCalendarSpaceBooking` varchar(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'N\',
  `lockerNumber` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `vehicleRegistration` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `personalBackground` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `messengerLastBubble` date DEFAULT NULL,
  `privacy` longtext COLLATE utf8_unicode_ci,
  `dayType` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT \'Student day type, as specified in the application form.\',
  `studentAgreements` longtext COLLATE utf8_unicode_ci,
  `googleAPIRefreshToken` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `receiveNotificationEmails` varchar(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'Y\',
  `fields` longtext COLLATE utf8_unicode_ci COMMENT \'Serialised array of custom field values(DC2Type:array)\',
  `gibbonRoleIDPrimary` int(3) UNSIGNED ZEROFILL DEFAULT NULL,
  `gibbonHouseID` int(3) UNSIGNED ZEROFILL DEFAULT NULL,
  `AcademicYearIDClassOf` int(3) UNSIGNED ZEROFILL DEFAULT NULL,
  ...
  KEY `IDX_FBF1667668D8F4F8` (`gibbonRoleIDPrimary`),
  KEY `IDX_FBF166768AF65507` (`gibbonHouseID`),
  KEY `IDX_FBF166768AB34571` (`AcademicYearIDClassOf`),
  KEY `IDX_FBF16676772C4226` (`gibbonApplicationFormID`),
  KEY `IDX_FBF166767E3D96BF` (`gibbonThemeIDPersonal`),
  KEY `IDX_FBF166764D960E0E` (`gibboni18nIDPersonal`),
  ...
  UNIQUE KEY `nameSchoolYear` (`name`,`AcademicYearID`),
  UNIQUE KEY `nameShortSchoolYear` (`nameShort`,`AcademicYearID`),
  KEY `IDX_86CF5C4371FA7520` (`AcademicYearID`),
  ...
  KEY `IDX_262DE8A75F72BC3` (`gibbonScaleID`)
        ...
        $this->addSql('CREATE TABLE `gibbonAcademicYear` (
  `AcademicYearID` int(3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `sequence` (`sequenceNumber`) USING BTREE
        ...
        $this->addSql('CREATE TABLE gibbonAcademicYearSpecialDay (gibbonAcademicYearSpecialDayID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, type VARCHAR(14) NOT NULL, name VARCHAR(20) NOT NULL, description VARCHAR(255) NOT NULL, date DATE NOT NULL, schoolOpen TIME DEFAULT NULL, schoolStart TIME DEFAULT NULL, schoolEnd TIME DEFAULT NULL, schoolClose TIME DEFAULT NULL, gibbonAcademicYearTermID INT(5) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_EB4E375D88C7C454 (gibbonAcademicYearTermID), UNIQUE INDEX date (date), PRIMARY KEY(gibbonAcademicYearSpecialDayID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonAcademicYearTerm (gibbonAcademicYearTermID INT(5) UNSIGNED ZEROFILL AUTO_INCREMENT, sequenceNumber INT(5), name VARCHAR(20) NOT NULL, nameShort VARCHAR(4) NOT NULL, firstDay DATE NOT NULL, lastDay DATE NOT NULL, AcademicYearID INT(3) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_41C4671071FA7520 (AcademicYearID), UNIQUE INDEX sequenceNumber (sequenceNumber, AcademicYearID), PRIMARY KEY(gibbonAcademicYearTermID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
  ...
  KEY `gibbonTTColumnID` (`gibbonTTColumnID`)
        ...
        $this->addSql('ALTER TABLE gibbonActivity ADD CONSTRAINT FK_F971E05871FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonApplicationForm ADD CONSTRAINT FK_A309B59CF9B7736F FOREIGN KEY (AcademicYearIDEntry) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonBehaviour ADD CONSTRAINT FK_64915B371FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonBehaviourLetter ADD CONSTRAINT FK_5F61F91071FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonCourse ADD CONSTRAINT FK_D9B3D8B971FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonFamilyUpdate ADD CONSTRAINT FK_438A3D3B71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceBillingSchedule ADD CONSTRAINT FK_EC0D8C7D71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceFee ADD CONSTRAINT FK_7D222CFC71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceInvoice ADD CONSTRAINT FK_B921551771FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceInvoiceeUpdate ADD CONSTRAINT FK_848117171FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonFirstAid ADD CONSTRAINT FK_ABF0052771FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonGroup ADD CONSTRAINT FK_FAE2DDF371FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql("ALTER TABLE gibbonImportHistory ADD CONSTRAINT FK_7DB5226499EB8EA2 FOREIGN KEY (performed_by) REFERENCES gibbonPerson (gibbonPersonID)");
        ...
        $this->addSql('ALTER TABLE gibbonLog ADD CONSTRAINT FK_C012275571FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonMarkbookColumn ADD CONSTRAINT FK_AA57806E88C7C454 FOREIGN KEY (gibbonAcademicYearTermID) REFERENCES gibbonAcademicYearTerm (gibbonAcademicYearTermID)');
        ...
        $this->addSql('ALTER TABLE gibbonPerson ADD CONSTRAINT FK_FBF166768AB34571 FOREIGN KEY (AcademicYearIDClassOf) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonPersonMedicalUpdate ADD CONSTRAINT FK_EEB6690471FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonPersonUpdate ADD CONSTRAINT FK_D3CBB18C71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonPlannerParentWeeklyEmailSummary ADD CONSTRAINT FK_2E7C18B771FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonRollGroup ADD CONSTRAINT FK_86CF5C4371FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonAcademicYearSpecialDay ADD CONSTRAINT FK_EB4E375D88C7C454 FOREIGN KEY (gibbonAcademicYearTermID) REFERENCES gibbonAcademicYearTerm (gibbonAcademicYearTermID)');
        $this->addSql('ALTER TABLE gibbonAcademicYearTerm ADD CONSTRAINT FK_41C4671071FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonStaffAbsence ADD CONSTRAINT FK_2FE5FEF771FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonStaffCoverage ADD CONSTRAINT FK_946E51DE71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonStudentEnrolment ADD CONSTRAINT FK_ABD4EFFD71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
        ...
        $this->addSql('ALTER TABLE gibbonTT ADD CONSTRAINT FK_9431F94371FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (AcademicYearID)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE gibbonAcademicYear');
        $this->addSql('DROP TABLE gibbonAcademicYearSpecialDay');
        $this->addSql('DROP TABLE gibbonAcademicYearTerm');
