...
final class Version20000101010000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `gibbonActivity` (gibbonActivityID INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT, active VARCHAR(1) DEFAULT \'Y\' NOT NULL, registration VARCHAR(1) DEFAULT \'Y\' NOT NULL COMMENT \'Can a parent/student select this for registration?\', name VARCHAR(40) NOT NULL, provider VARCHAR(8) DEFAULT \'School\' NOT NULL, type VARCHAR(255) NOT NULL, gibbonAcademicYearTermIDList LONGTEXT NOT NULL, listingStart DATE DEFAULT NULL, listingEnd DATE DEFAULT NULL, programStart DATE DEFAULT NULL, programEnd DATE DEFAULT NULL, description LONGTEXT DEFAULT NULL, payment NUMERIC(8, 2) DEFAULT NULL, paymentFirmness VARCHAR(9) DEFAULT \'Finalised\', paymentType VARCHAR(24) DEFAULT \'Entire Programme\', gibbonYearGroupIDList VARCHAR(255) NOT NULL, maxParticipants INT(3), AcademicYearID INT(3) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_F971E05871FA7520 (AcademicYearID), PRIMARY KEY(gibbonActivityID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
  ...
  UNIQUE KEY `nameShortYear` (`AcademicYearID`,`nameShort`),
  ...
  KEY `gibbonPersonID` (`gibbonPersonID`,`role`)
        ...
        $this->addSql('CREATE TABLE gibbonFinanceBillingSchedule (gibbonFinanceBillingScheduleID INT(6) UNSIGNED ZEROFILL AUTO_INCREMENT, name VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, active VARCHAR(1) DEFAULT \'Y\' NOT NULL, invoiceIssueDate DATE DEFAULT NULL, invoiceDueDate DATE DEFAULT NULL, timestampCreator DATETIME DEFAULT NULL, timestampUpdate DATETIME DEFAULT NULL, AcademicYearID INT(3) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDCreator INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDUpdate INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_EC0D8C7D71FA7520 (AcademicYearID), INDEX IDX_EC0D8C7DFF59AAB0 (gibbonPersonIDCreator), INDEX IDX_EC0D8C7DAE8C8C10 (gibbonPersonIDUpdate), PRIMARY KEY(gibbonFinanceBillingScheduleID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        ...
        $this->addSql('CREATE TABLE gibbonLog (gibbonLogID INT(16) UNSIGNED ZEROFILL AUTO_INCREMENT, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, title VARCHAR(50) NOT NULL, serialisedArray LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', ip VARCHAR(15) DEFAULT NULL, gibbonModuleID INT(4) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, AcademicYearID INT(3) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_C0122755CB86AD4B (gibbonModuleID), INDEX IDX_C0122755CC6782D6 (gibbonPersonID), INDEX IDX_C012275571FA7520 (AcademicYearID), PRIMARY KEY(gibbonLogID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
  ...
  `gibbonAcademicYearTermID` int(5) UNSIGNED ZEROFILL DEFAULT NULL,
  `idAttainment` int(5) UNSIGNED ZEROFILL DEFAULT NULL,
  `idEffort` int(5) UNSIGNED ZEROFILL DEFAULT NULL,
  ...
  KEY `IDX_30734075FF59AAB0` (`gibbonPersonIDCreator`)
        ...
        $this->addSql('CREATE TABLE gibbonPlannerParentWeeklyEmailSummary (gibbonPlannerParentWeeklyEmailSummaryID INT(14) UNSIGNED ZEROFILL AUTO_INCREMENT, weekOfYear INT(2), `key` VARCHAR(40) NOT NULL, confirmed VARCHAR(1) DEFAULT \'N\' NOT NULL, AcademicYearID INT(3) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDParent INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDStudent INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_2E7C18B771FA7520 (AcademicYearID), INDEX IDX_2E7C18B7B27D927 (gibbonPersonIDParent), INDEX IDX_2E7C18B7F47CEFE0 (gibbonPersonIDStudent), UNIQUE INDEX `key` (`key`), PRIMARY KEY(gibbonPlannerParentWeeklyEmailSummaryID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        ...
        $this->addSql('CREATE TABLE gibbonRubric (gibbonRubricID INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT, name VARCHAR(50) NOT NULL, category VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, active VARCHAR(1) NOT NULL, scope VARCHAR(10) NOT NULL, gibbonYearGroupIDList VARCHAR(255) NOT NULL, gibbonDepartmentID INT(4) UNSIGNED ZEROFILL AUTO_INCREMENT, id INT(5) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDCreator INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_AFE9B66C6DFE7E92 (gibbonDepartmentID), INDEX IDX_AFE9B66C5F72BC3 (id), INDEX IDX_AFE9B66CFF59AAB0 (gibbonPersonIDCreator), PRIMARY KEY(gibbonRubricID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
  ...
  UNIQUE KEY `initials` (`initials`)
        ...
        $this->addSql('CREATE TABLE gibbonStudentEnrolment (gibbonStudentEnrolmentID INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT, rollOrder INT(2), gibbonPersonID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, AcademicYearID INT(3) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonYearGroupID INT(3) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonRollGroupID INT(5) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_ABD4EFFDCC6782D6 (gibbonPersonID), INDEX AcademicYearID (AcademicYearID), INDEX gibbonYearGroupID (gibbonYearGroupID), INDEX gibbonRollGroupID (gibbonRollGroupID), INDEX gibbonPersonIndex (gibbonPersonID, AcademicYearID), PRIMARY KEY(gibbonStudentEnrolmentID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        ...
        $this->addSql('CREATE TABLE gibbonTT (gibbonTTID INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT, name VARCHAR(30) NOT NULL, nameShort VARCHAR(12) NOT NULL, nameShortDisplay VARCHAR(24) DEFAULT \'Day Of The Week\' NOT NULL, gibbonYearGroupIDList VARCHAR(255) NOT NULL, active VARCHAR(1) NOT NULL, AcademicYearID INT(3) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_9431F94371FA7520 (AcademicYearID), PRIMARY KEY(gibbonTTID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
  ...
  KEY `gibbonTTColumnID` (`gibbonTTColumnID`)
        ...
        $this->addSql('CREATE TABLE gibbonTTSpaceBooking (gibbonTTSpaceBookingID INT(12) UNSIGNED ZEROFILL AUTO_INCREMENT, foreignKey VARCHAR(30) DEFAULT \'gibbonFacilityID\' NOT NULL, foreignKeyID INT(10) UNSIGNED ZEROFILL, date DATE NOT NULL, timeStart TIME NOT NULL, timeEnd TIME NOT NULL, gibbonPersonID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_1A34AD71CC6782D6 (gibbonPersonID), PRIMARY KEY(gibbonTTSpaceBookingID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonTTSpaceChange (gibbonTTSpaceChangeID INT(12) UNSIGNED ZEROFILL AUTO_INCREMENT, date DATE NOT NULL, gibbonTTDayRowClassID INT(12) UNSIGNED ZEROFILL AUTO_INCREMENT, facility INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX facility (facility), INDEX IDX_772A323ECC6782D6 (gibbonPersonID), INDEX gibbonTTDayRowClassID (gibbonTTDayRowClassID), INDEX date (date), PRIMARY KEY(gibbonTTSpaceChangeID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        ...
        $this->addSql('ALTER TABLE gibbonActivity ADD CONSTRAINT FK_F971E05871FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        ...
        $this->addSql('ALTER TABLE gibbonActivityAttendance ADD CONSTRAINT FK_2357A71211A14ED FOREIGN KEY (gibbonPersonIDTaker) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonActivitySlot ADD CONSTRAINT FK_59227ABBD8D64BA0 FOREIGN KEY (gibbonSpaceID) REFERENCES gibbonFacility (id)');
        $this->addSql('ALTER TABLE gibbonActivitySlot ADD CONSTRAINT FK_59227ABB2817C0E1 FOREIGN KEY (gibbonDaysOfWeekID) REFERENCES gibbonDaysOfWeek (id)');
        ...
        $this->addSql('ALTER TABLE gibbonActivityStaff ADD CONSTRAINT FK_CDFE4137CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonActivityStudent ADD CONSTRAINT FK_413CBAAFCC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonAlarm ADD CONSTRAINT FK_E3BDDFEBCC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonAlarmConfirm ADD CONSTRAINT FK_8E3CE4BCCC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonApplicationForm ADD CONSTRAINT FK_A309B59CF9B7736F FOREIGN KEY (AcademicYearIDEntry) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonApplicationForm ADD CONSTRAINT FK_A309B59C9DE35FD8 FOREIGN KEY (gibbonYearGroupIDEntry) REFERENCES gibbonYearGroup (id)');
        $this->addSql('ALTER TABLE gibbonApplicationForm ADD CONSTRAINT FK_A309B59C7DF7AB4B FOREIGN KEY (parent1gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonApplicationForm ADD CONSTRAINT FK_A309B59CA85AE4EC FOREIGN KEY (gibbonRollGroupID) REFERENCES gibbonRollGroup (id)');
        $this->addSql('ALTER TABLE gibbonApplicationForm ADD CONSTRAINT FK_A309B59C51F0BB1F FOREIGN KEY (gibbonFamilyID) REFERENCES gibbonFamily (id)');
        ...
        $this->addSql('ALTER TABLE gibbonApplicationFormRelationship ADD CONSTRAINT FK_5E0017E7CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonBehaviour ADD CONSTRAINT FK_64915B371FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonBehaviour ADD CONSTRAINT FK_64915B3CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonBehaviour ADD CONSTRAINT FK_64915B3FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonBehaviourLetter ADD CONSTRAINT FK_5F61F91071FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonBehaviourLetter ADD CONSTRAINT FK_5F61F910CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonCourse ADD CONSTRAINT FK_D9B3D8B971FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonCourse ADD CONSTRAINT FK_D9B3D8B96DFE7E92 FOREIGN KEY (gibbonDepartmentID) REFERENCES gibbonDepartment (id)');
        ...
        $this->addSql('ALTER TABLE gibbonCourseClass ADD CONSTRAINT FK_455FF3977DD4B430 FOREIGN KEY (gibbonScaleIDTarget) REFERENCES gibbonScale (id)');
        ...
        $this->addSql('ALTER TABLE gibbonCourseClassMap ADD CONSTRAINT FK_97F9BC70A85AE4EC FOREIGN KEY (gibbonRollGroupID) REFERENCES gibbonRollGroup (id)');
        $this->addSql('ALTER TABLE gibbonCourseClassMap ADD CONSTRAINT FK_97F9BC70427372F FOREIGN KEY (gibbonYearGroupID) REFERENCES gibbonYearGroup (id)');
        ...
        $this->addSql('ALTER TABLE gibbonCourseClassPerson ADD CONSTRAINT FK_D9B888E9CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonCrowdAssessDiscuss ADD CONSTRAINT FK_D17E7086CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceBillingSchedule ADD CONSTRAINT FK_EC0D8C7D71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonFinanceBillingSchedule ADD CONSTRAINT FK_EC0D8C7DFF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceBillingSchedule ADD CONSTRAINT FK_EC0D8C7DAE8C8C10 FOREIGN KEY (gibbonPersonIDUpdate) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceBudget ADD CONSTRAINT FK_EE793C02FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceBudget ADD CONSTRAINT FK_EE793C02AE8C8C10 FOREIGN KEY (gibbonPersonIDUpdate) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceBudgetCycle ADD CONSTRAINT FK_2AA76753FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceBudgetCycle ADD CONSTRAINT FK_2AA76753AE8C8C10 FOREIGN KEY (gibbonPersonIDUpdate) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceBudgetPerson ADD CONSTRAINT FK_AF223270CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceExpense ADD CONSTRAINT FK_47ECFF52E77C4DE FOREIGN KEY (gibbonPersonIDPayment) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceExpense ADD CONSTRAINT FK_47ECFF5FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceExpenseApprover ADD CONSTRAINT FK_38833027CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceExpenseApprover ADD CONSTRAINT FK_38833027FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceExpenseApprover ADD CONSTRAINT FK_38833027AE8C8C10 FOREIGN KEY (gibbonPersonIDUpdate) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceExpenseLog ADD CONSTRAINT FK_FFA208A0CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceFee ADD CONSTRAINT FK_7D222CFC71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceFee ADD CONSTRAINT FK_7D222CFCFF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceFee ADD CONSTRAINT FK_7D222CFCAE8C8C10 FOREIGN KEY (gibbonPersonIDUpdate) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceFeeCategory ADD CONSTRAINT FK_14C5A939FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceFeeCategory ADD CONSTRAINT FK_14C5A939AE8C8C10 FOREIGN KEY (gibbonPersonIDUpdate) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceInvoice ADD CONSTRAINT FK_B921551771FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceInvoice ADD CONSTRAINT FK_B9215517FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceInvoice ADD CONSTRAINT FK_B9215517AE8C8C10 FOREIGN KEY (gibbonPersonIDUpdate) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceInvoicee ADD CONSTRAINT FK_6CB0DEC8CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFinanceInvoiceeUpdate ADD CONSTRAINT FK_848117171FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        ...
        $this->addSql('ALTER TABLE gibbonFinanceInvoiceeUpdate ADD CONSTRAINT FK_848117171106375 FOREIGN KEY (gibbonPersonIDUpdater) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonFirstAid ADD CONSTRAINT FK_ABF0052759859738 FOREIGN KEY (gibbonPersonIDPatient) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonFirstAid ADD CONSTRAINT FK_ABF0052722759506 FOREIGN KEY (gibbonPersonIDFirstAider) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonFirstAid ADD CONSTRAINT FK_ABF0052771FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonGroup ADD CONSTRAINT FK_FAE2DDF3659378D6 FOREIGN KEY (gibbonPersonIDOwner) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonGroup ADD CONSTRAINT FK_FAE2DDF371FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        ...
        $this->addSql('ALTER TABLE gibbonGroupPerson ADD CONSTRAINT FK_15367BAACC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonHook ADD CONSTRAINT FK_5418FD5ECB86AD4B FOREIGN KEY (gibbonModuleID) REFERENCES gibbonModule (id)');
        $this->addSql("ALTER TABLE gibbonImportHistory ADD CONSTRAINT FK_7DB5226499EB8EA2 FOREIGN KEY (performed_by) REFERENCES gibbonPerson (id)");
        ...
        $this->addSql('ALTER TABLE gibbonInternalAssessmentColumn ADD CONSTRAINT FK_E0A1D88A2C639785 FOREIGN KEY (idAttainment) REFERENCES gibbonScale (id)');
        $this->addSql('ALTER TABLE gibbonInternalAssessmentColumn ADD CONSTRAINT FK_E0A1D88AD395ACF8 FOREIGN KEY (idEffort) REFERENCES gibbonScale (id)');
        $this->addSql('ALTER TABLE gibbonInternalAssessmentColumn ADD CONSTRAINT FK_E0A1D88AFF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonInternalAssessmentColumn ADD CONSTRAINT FK_E0A1D88A519966BA FOREIGN KEY (gibbonPersonIDLastEdit) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonInternalAssessmentEntry ADD CONSTRAINT FK_B09C6F5F47CEFE0 FOREIGN KEY (gibbonPersonIDStudent) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonInternalAssessmentEntry ADD CONSTRAINT FK_B09C6F5519966BA FOREIGN KEY (gibbonPersonIDLastEdit) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonLog ADD CONSTRAINT FK_C0122755CB86AD4B FOREIGN KEY (gibbonModuleID) REFERENCES gibbonModule (id)');
        $this->addSql('ALTER TABLE gibbonLog ADD CONSTRAINT FK_C0122755CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonLog ADD CONSTRAINT FK_C012275571FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        ...
        $this->addSql('ALTER TABLE gibbonMarkbookColumn ADD CONSTRAINT FK_AA57806E88C7C454 FOREIGN KEY (gibbonAcademicYearTermID) REFERENCES gibbonAcademicYearTerm (id)');
        $this->addSql('ALTER TABLE gibbonMarkbookColumn ADD CONSTRAINT FK_AA57806E2C639785 FOREIGN KEY (idAttainment) REFERENCES gibbonScale (id)');
        $this->addSql('ALTER TABLE gibbonMarkbookColumn ADD CONSTRAINT FK_AA57806ED395ACF8 FOREIGN KEY (idEffort) REFERENCES gibbonScale (id)');
        ...
        $this->addSql('ALTER TABLE gibbonMarkbookColumn ADD CONSTRAINT FK_AA57806EFF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonMarkbookColumn ADD CONSTRAINT FK_AA57806E519966BA FOREIGN KEY (gibbonPersonIDLastEdit) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonMarkbookEntry ADD CONSTRAINT FK_22F46391F47CEFE0 FOREIGN KEY (gibbonPersonIDStudent) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonMarkbookEntry ADD CONSTRAINT FK_22F46391519966BA FOREIGN KEY (gibbonPersonIDLastEdit) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonMarkbookTarget ADD CONSTRAINT FK_916B28ECF47CEFE0 FOREIGN KEY (gibbonPersonIDStudent) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonMarkbookTarget ADD CONSTRAINT FK_916B28EC5E440573 FOREIGN KEY (gibbonScaleGradeID) REFERENCES gibbonScaleGrade (id)');
        ...
        $this->addSql('ALTER TABLE gibbonMessenger ADD CONSTRAINT FK_C7127C4CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonMessengerCannedResponse ADD CONSTRAINT FK_C83786BFFF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonMessengerReceipt ADD CONSTRAINT FK_30BB7708CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonNotification ADD CONSTRAINT FK_D5180450CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonNotification ADD CONSTRAINT FK_D5180450CB86AD4B FOREIGN KEY (gibbonModuleID) REFERENCES gibbonModule (id)');
        ...
        $this->addSql('ALTER TABLE gibbonNotificationListener ADD CONSTRAINT FK_6313F17ECC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonOutcome ADD CONSTRAINT FK_307340756DFE7E92 FOREIGN KEY (gibbonDepartmentID) REFERENCES gibbonDepartment (id)');
        $this->addSql('ALTER TABLE gibbonOutcome ADD CONSTRAINT FK_30734075FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPayment ADD CONSTRAINT FK_6DE7A9BACC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPersonMedical ADD CONSTRAINT FK_CD40DFDBCC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonPersonMedicalCondition ADD CONSTRAINT FK_9F35C9A7891EFB5B FOREIGN KEY (id) REFERENCES gibbonAlertLevel (id)');
        ...
        $this->addSql('ALTER TABLE gibbonPersonMedicalConditionUpdate ADD CONSTRAINT FK_4E2F6CEC891EFB5B FOREIGN KEY (id) REFERENCES gibbonAlertLevel (id)');
        $this->addSql('ALTER TABLE gibbonPersonMedicalConditionUpdate ADD CONSTRAINT FK_4E2F6CEC71106375 FOREIGN KEY (gibbonPersonIDUpdater) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPersonMedicalSymptoms ADD CONSTRAINT FK_2C6BF3A5CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPersonMedicalSymptoms ADD CONSTRAINT FK_2C6BF3A511A14ED FOREIGN KEY (gibbonPersonIDTaker) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPersonMedicalUpdate ADD CONSTRAINT FK_EEB6690471FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        ...
        $this->addSql('ALTER TABLE gibbonPersonMedicalUpdate ADD CONSTRAINT FK_EEB66904CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPersonMedicalUpdate ADD CONSTRAINT FK_EEB6690471106375 FOREIGN KEY (gibbonPersonIDUpdater) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPersonUpdate ADD CONSTRAINT FK_D3CBB18C71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonPersonUpdate ADD CONSTRAINT FK_D3CBB18CCC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPersonUpdate ADD CONSTRAINT FK_D3CBB18C71106375 FOREIGN KEY (gibbonPersonIDUpdater) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonPlannerEntry ADD CONSTRAINT FK_B35E3CEEFF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPlannerEntry ADD CONSTRAINT FK_B35E3CEE519966BA FOREIGN KEY (gibbonPersonIDLastEdit) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonPlannerEntryDiscuss ADD CONSTRAINT FK_A2D5383ECC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonPlannerEntryGuest ADD CONSTRAINT FK_E9A57557CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonPlannerEntryHomework ADD CONSTRAINT FK_ED6C8A2ECC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonPlannerEntryStudentHomework ADD CONSTRAINT FK_F458CB62CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonPlannerEntryStudentTracker ADD CONSTRAINT FK_936AA4E7CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPlannerParentWeeklyEmailSummary ADD CONSTRAINT FK_2E7C18B771FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonPlannerParentWeeklyEmailSummary ADD CONSTRAINT FK_2E7C18B7B27D927 FOREIGN KEY (gibbonPersonIDParent) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonPlannerParentWeeklyEmailSummary ADD CONSTRAINT FK_2E7C18B7F47CEFE0 FOREIGN KEY (gibbonPersonIDStudent) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonResource ADD CONSTRAINT FK_E9941D14CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonRubric ADD CONSTRAINT FK_AFE9B66C6DFE7E92 FOREIGN KEY (gibbonDepartmentID) REFERENCES gibbonDepartment (id)');
        $this->addSql('ALTER TABLE gibbonRubric ADD CONSTRAINT FK_AFE9B66C5F72BC3 FOREIGN KEY (id) REFERENCES gibbonScale (id)');
        $this->addSql('ALTER TABLE gibbonRubric ADD CONSTRAINT FK_AFE9B66CFF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonRubricColumn ADD CONSTRAINT FK_E31DA4325E440573 FOREIGN KEY (gibbonScaleGradeID) REFERENCES gibbonScaleGrade (id)');
        ...
        $this->addSql('ALTER TABLE gibbonRubricEntry ADD CONSTRAINT FK_1977277CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonStaff ADD CONSTRAINT FK_D54C6AA4CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonStaffAbsence ADD CONSTRAINT FK_2FE5FEF78A15C624 FOREIGN KEY (gibbonStaffAbsenceTypeID) REFERENCES gibbonStaffAbsenceType (id)');
        $this->addSql('ALTER TABLE gibbonStaffAbsence ADD CONSTRAINT FK_2FE5FEF771FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonStaffAbsence ADD CONSTRAINT FK_2FE5FEF7CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonStaffAbsence ADD CONSTRAINT FK_2FE5FEF79794905 FOREIGN KEY (gibbonPersonIDApproval) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonStaffAbsence ADD CONSTRAINT FK_2FE5FEF7FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonStaffApplicationForm ADD CONSTRAINT FK_48D734D9CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonStaffContract ADD CONSTRAINT FK_28B78AECFF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonStaffCoverage ADD CONSTRAINT FK_946E51DE71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonStaffCoverage ADD CONSTRAINT FK_946E51DECC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonStaffCoverage ADD CONSTRAINT FK_946E51DE4DA9DC74 FOREIGN KEY (gibbonPersonIDStatus) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonStaffCoverage ADD CONSTRAINT FK_946E51DE4ACF2F45 FOREIGN KEY (gibbonPersonIDCoverage) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonStaffCoverageDate ADD CONSTRAINT FK_AD45031DFED701B3 FOREIGN KEY (gibbonPersonIDUnavailable) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonStaffJobOpening ADD CONSTRAINT FK_C9D57E5CFF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonStudentEnrolment ADD CONSTRAINT FK_ABD4EFFDCC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonStudentEnrolment ADD CONSTRAINT FK_ABD4EFFD71FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonStudentEnrolment ADD CONSTRAINT FK_ABD4EFFD427372F FOREIGN KEY (gibbonYearGroupID) REFERENCES gibbonYearGroup (id)');
        $this->addSql('ALTER TABLE gibbonStudentEnrolment ADD CONSTRAINT FK_ABD4EFFDA85AE4EC FOREIGN KEY (gibbonRollGroupID) REFERENCES gibbonRollGroup (id)');
        $this->addSql('ALTER TABLE gibbonStudentNote ADD CONSTRAINT FK_48CB2167CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonStudentNote ADD CONSTRAINT FK_48CB21671E9DC1FF FOREIGN KEY (gibbonStudentNoteCategoryID) REFERENCES gibbonStudentNoteCategory (id)');
        $this->addSql('ALTER TABLE gibbonStudentNote ADD CONSTRAINT FK_48CB2167FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonSubstitute ADD CONSTRAINT FK_24133EE2CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonTT ADD CONSTRAINT FK_9431F94371FA7520 FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        ...
        $this->addSql('ALTER TABLE gibbonTTDayRowClass ADD CONSTRAINT FK_C832432ED8D64BA0 FOREIGN KEY (facility) REFERENCES gibbonFacility (id)');
        ...
        $this->addSql('ALTER TABLE gibbonTTDayRowClassException ADD CONSTRAINT FK_D25EB853CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonTTSpaceBooking ADD CONSTRAINT FK_1A34AD71CC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonTTSpaceChange ADD CONSTRAINT FK_772A323ED8D64BA0 FOREIGN KEY (facility) REFERENCES gibbonFacility (id)');
        $this->addSql('ALTER TABLE gibbonTTSpaceChange ADD CONSTRAINT FK_772A323ECC6782D6 FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        ...
        $this->addSql('ALTER TABLE gibbonUnit ADD CONSTRAINT FK_2CFBB258FF59AAB0 FOREIGN KEY (gibbonPersonIDCreator) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonUnit ADD CONSTRAINT FK_2CFBB258519966BA FOREIGN KEY (gibbonPersonIDLastEdit) REFERENCES gibbonPerson (id)');
