...
(00210, 'User Admin', 'religions', 'Religions', 'Comma-separated list of religions available in system', ',Nonreligious/Agnostic/Atheist,Buddhism,Christianity,Hinduism,Islam,Judaism,Other'),
