...
(0000022, 0004, 'View Departments', 0, 'Departments', 'Allows users to view all department details.', 'list, details, course_details, department_course_class.php, department_course_class_full.php, department_course_unit_add.php, department_course_unit_edit.php, department_course_unit_delete.php, department_course_unit_duplicate.php, department_edit.php, course_edit', 'list', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y'),
