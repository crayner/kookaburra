...
final class Version20000101000000 extends AbstractMigration
{
  ...
  KEY `FK_A364BEADB6AA0365` (`actionID`)
        ...
        $this->addSql('CREATE TABLE gibbonOutcome (gibbonOutcomeID INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT, name VARCHAR(100) NOT NULL, nameShort VARCHAR(14) NOT NULL, category VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, active VARCHAR(1) NOT NULL, scope VARCHAR(16) NOT NULL, gibbonYearGroupIDList VARCHAR(255) NOT NULL, gibbonDepartmentID INT(4) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDCreator INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_307340756DFE7E92 (gibbonDepartmentID), INDEX IDX_30734075FF59AAB0 (gibbonPersonIDCreator), PRIMARY KEY(gibbonOutcomeID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        ...
        $this->addSql('CREATE TABLE gibbonRollGroup (gibbonRollGroupID INT(5) UNSIGNED ZEROFILL AUTO_INCREMENT, name VARCHAR(10) NOT NULL, nameShort VARCHAR(5) NOT NULL, attendance VARCHAR(1) DEFAULT \'Y\' NOT NULL, website VARCHAR(255) NOT NULL, gibbonSchoolYearID INT(3) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDTutor INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDTutor2 INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDTutor3 INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDEA INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDEA2 INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonPersonIDEA3 INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonSpaceID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonRollGroupIDNext INT(5) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_86CF5C4371FA7520 (gibbonSchoolYearID), INDEX IDX_86CF5C4333F4D8E2 (gibbonPersonIDTutor), INDEX IDX_86CF5C4354E2C981 (gibbonPersonIDTutor2), INDEX IDX_86CF5C4323E5F917 (gibbonPersonIDTutor3), INDEX IDX_86CF5C4319D8944B (gibbonPersonIDEA), INDEX IDX_86CF5C43FBC2FE81 (gibbonPersonIDEA2), INDEX IDX_86CF5C438CC5CE17 (gibbonPersonIDEA3), INDEX IDX_86CF5C43D8D64BA0 (gibbonSpaceID), INDEX IDX_86CF5C43E06A7FA (gibbonRollGroupIDNext), PRIMARY KEY(gibbonRollGroupID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        ...
        $this->addSql('CREATE TABLE gibbonScaleGrade (gibbonScaleGradeID INT(7) UNSIGNED ZEROFILL AUTO_INCREMENT, value VARCHAR(10) NOT NULL, descriptor VARCHAR(50) NOT NULL, sequenceNumber INT(5), isDefault VARCHAR(1) DEFAULT \'N\' NOT NULL, gibbonScaleID INT(5) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_262DE8A75F72BC3 (gibbonScaleID), PRIMARY KEY(gibbonScaleGradeID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        ...
        $this->addSql('CREATE TABLE gibbonStaff (gibbonStaffID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, type VARCHAR(20) NOT NULL, initials VARCHAR(4) DEFAULT NULL, jobTitle VARCHAR(100) NOT NULL, smartWorkflowHelp VARCHAR(1) DEFAULT \'Y\' NOT NULL, firstAidQualified VARCHAR(1) NOT NULL, firstAidExpiry DATE DEFAULT NULL, countryOfOrigin VARCHAR(80) NOT NULL, qualifications VARCHAR(255) NOT NULL, biography LONGTEXT NOT NULL, biographicalGrouping VARCHAR(100) NOT NULL COMMENT \'Used for group staff when creating a staff directory.\', biographicalGroupingPriority INT(3), gibbonPersonID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, UNIQUE INDEX gibbonPersonID (gibbonPersonID), UNIQUE INDEX initials (initials), PRIMARY KEY(gibbonStaffID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        ...
        $this->addSql('CREATE TABLE gibbonTTDay (gibbonTTDayID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, name VARCHAR(12) NOT NULL, nameShort VARCHAR(4) NOT NULL, color VARCHAR(6) NOT NULL, fontColor VARCHAR(6) NOT NULL, gibbonTTID INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonTTColumnID INT(6) UNSIGNED ZEROFILL AUTO_INCREMENT, INDEX IDX_3B9106B3EE6A175 (gibbonTTID), INDEX gibbonTTColumnID (gibbonTTColumnID), PRIMARY KEY(gibbonTTDayID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gibbonLibraryItem DROP FOREIGN KEY FK_7D8DF16E6DFE7E92');
        ...
        $this->addSql('ALTER TABLE gibbonLibraryItemEvent DROP FOREIGN KEY FK_91CB122520179A14');
        $this->addSql('ALTER TABLE gibbonLibraryItem DROP FOREIGN KEY FK_7D8DF16EE1BB9F5');
        ...
        $this->addSql('ALTER TABLE gibbonLibraryItem DROP FOREIGN KEY FK_7D8DF16EC4597887');
        $this->addSql('ALTER TABLE gibbonLibraryItem DROP FOREIGN KEY FK_7D8DF16EE0330702');
        $this->addSql('ALTER TABLE gibbonLibraryItem DROP FOREIGN KEY FK_7D8DF16ECCCD7B64');
        $this->addSql('ALTER TABLE gibbonLibraryItem DROP FOREIGN KEY FK_7D8DF16EFA1AE1AB');
        $this->addSql('ALTER TABLE gibbonLibraryItem DROP FOREIGN KEY FK_7D8DF16EFF59AAB0');
        $this->addSql('ALTER TABLE gibbonLibraryItem DROP FOREIGN KEY FK_7D8DF16EAE8C8C10');
        $this->addSql('ALTER TABLE gibbonLibraryItemEvent DROP FOREIGN KEY FK_91CB1225E0330702');
        $this->addSql('ALTER TABLE gibbonLibraryItemEvent DROP FOREIGN KEY FK_91CB1225D2C06C05');
        $this->addSql('ALTER TABLE gibbonLibraryItemEvent DROP FOREIGN KEY FK_91CB1225FA1AE1AB');
        $this->addSql('ALTER TABLE gibbonLibraryItemEvent DROP FOREIGN KEY FK_91CB12251EBCE61E');
        ...
        $this->addSql('ALTER TABLE gibbonLibraryItem DROP FOREIGN KEY FK_7D8DF16E2797629C');
        ...
        $this->addSql('ALTER TABLE gibbonLibraryItem DROP FOREIGN KEY FK_7D8DF16ED8D64BA0');
