 ...
 * @ORM\Table(options={"auto_increment": 1}, name="FinanceInvoice")
...
class FinanceInvoice
{
     ...
     * @var integer|null
     * @ORM\Id
     * @ORM\Column(type="bigint", name="gibbonFinanceInvoiceID", columnDefinition="INT(14) UNSIGNED ZEROFILL AUTO_INCREMENT")
     * @ORM\GeneratedValue
     */
    private $id;
