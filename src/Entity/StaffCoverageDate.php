...
class StaffCoverageDate implements EntityInterface
{
     ...
     * @var integer|null
     * @ORM\Id
     * @ORM\Column(type="bigint", name="gibbonStaffCoverageDateID", columnDefinition="INT(14) UNSIGNED AUTO_INCREMENT")
     * @ORM\GeneratedValue
     */
    private $id;
     ...
     * @ORM\JoinColumn(name="gibbonPersonIDUnavailable", referencedColumnName="id", nullable=false)
     */
