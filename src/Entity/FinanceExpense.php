...
class FinanceExpense
{
     ...
     * @var integer|null
     * @ORM\Id()
     * @ORM\Column(type="bigint", name="gibbonFinanceExpenseID", columnDefinition="INT(14) UNSIGNED AUTO_INCREMENT")
     * @ORM\GeneratedValue
     */
    private $id;
     ...
     * @ORM\JoinColumn(name="gibbonPersonIDPayment", referencedColumnName="id")
     */
