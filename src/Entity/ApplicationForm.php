...
class ApplicationForm
{
     ...
     * @var integer|null
     * @ORM\Id
     * @ORM\Column(type="integer", name="gibbonApplicationFormID", columnDefinition="INT(12) UNSIGNED AUTO_INCREMENT")
     * @ORM\GeneratedValue
     */
    private $id;
     ...
     * @ORM\JoinColumn(name="gibbonRollGroupID", referencedColumnName="id", nullable=true)
     */
    private $rollGroup;
