...
class StaffCoverage implements EntityInterface
{
     ...
     * @var integer|null
     * @ORM\Id
     * @ORM\Column(type="bigint", name="gibbonStaffCoverageID", columnDefinition="INT(14) UNSIGNED AUTO_INCREMENT")
     * @ORM\GeneratedValue
     */
    private $id;
     ...
     * @return StaffCoverage
     */
    public function setAcademicYear(?AcademicYear $AcademicYear): StaffCoverage
    {
