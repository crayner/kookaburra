...
class FirstAid
{
     ...
     * @var integer|null
     * @ORM\Id
     * @ORM\Column(type="integer", name="gibbonFirstAidID", columnDefinition="INT(10) UNSIGNED AUTO_INCREMENT")
     * @ORM\GeneratedValue
     */
    private $id;
     ...
     * @ORM\JoinColumn(name="gibbonPersonIDPatient", referencedColumnName="id", nullable=false)
     */
    private $patient;
     ...
     * @var Person|null
     * @ORM\ManyToOne(targetEntity="Kookaburra\UserAdmin\Entity\Person")
     * @ORM\JoinColumn(name="gibbonPersonIDFirstAider", referencedColumnName="id", nullable=false)
     */
    private $firstAider;
