...
class Hook
{
     ...
     * @var integer|null
     * @ORM\Id
     * @ORM\Column(type="smallint", name="gibbonHookID", columnDefinition="INT(4) UNSIGNED AUTO_INCREMENT")
     * @ORM\GeneratedValue
     */
    private $id;
     ...
     * @ORM\JoinColumn(name="gibbonModuleID", referencedColumnName="id", nullable=false)
     */
    private $module;
