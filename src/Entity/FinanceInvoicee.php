 ...
 * @ORM\Table(options={"auto_increment": 1}, name="FinanceInvoicee")
 */
class FinanceInvoicee
{
    use BooleanList;
     ...
     * @var integer|null
     * @ORM\Id
     * @ORM\Column(type="integer", name="gibbonFinanceInvoiceeID", columnDefinition="INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT")
     * @ORM\GeneratedValue
     */
    private $id;
