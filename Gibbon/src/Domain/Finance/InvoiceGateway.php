...
class InvoiceGateway extends QueryableGateway
{
    ...
    public function queryInvoicesByYear(QueryCriteria $criteria, $gibbonSchoolYearID)
    {
        $query = $this
            ...
            ->leftJoin('gibbonStudentEnrolment', 'gibbonStudentEnrolment.gibbonPersonID=gibbonPerson.gibbonPersonID AND gibbonStudentEnrolment.academic_year=gibbonFinanceInvoice.gibbonSchoolYearID')
