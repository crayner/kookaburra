...
class Visualise
{
     ...
     * @return   void
     */
    public function __construct(string $absoluteURL, Page $page, ?int $gibbonPersonID = null, array $columns = [], array $rows = [], array $cells = [], array $contexts = [])
    {
     ...
     * @return Visualise
     */
    public function setColumns(array $columns): Visualise
    {
        $this->columns = $columns;
        return $this;
    }
     ...
     * @return Visualise
     */
    public function setRows(array $rows): Visualise
    {
        $this->rows = $rows;
        return $this;
    }
     ...
     * @return Visualise
     */
    public function setCells(array $cells): Visualise
    {
        $this->cells = $cells;
        return $this;
    }
     ...
     * @return Visualise
     */
    public function setContexts(array $contexts): Visualise
    {
        $this->contexts = $contexts;
        return $this;
    }
     ...
     * @return Visualise
     */
    public function setGibbonPersonID(?int $gibbonPersonID): Visualise
    {
        $this->gibbonPersonID = $gibbonPersonID;
        return $this;
    }
