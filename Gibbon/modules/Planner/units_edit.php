            ...
            try {
                if ($highestAction == 'Unit Planner_all') {
                    ...
                    $sql = 'SELECT gibbonCourse.*, gibbonSchoolYear.name as schoolYearName
                            FROM gibbonCourse
                            JOIN gibbonSchoolYear ON (gibbonSchoolYear.gibbonSchoolYearID=gibbonCourse.academic_year)
                            WHERE gibbonCourse.academic_year=:gibbonSchoolYearID AND gibbonCourse.gibbonCourseID=:gibbonCourseID';
                    ...
                    WHERE gibbonDepartmentStaff.gibbonPersonID=:gibbonPersonID AND (role='Coordinator' OR role='Assistant Coordinator' OR role='Teacher (Curriculum)') AND gibbonCourse.academic_year=:gibbonSchoolYearID AND gibbonCourse.gibbonCourseID=:gibbonCourseID ORDER BY gibbonCourse.nameShort";
                }
